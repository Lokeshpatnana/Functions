...
print(len(['False', 'None', 'True', 'and', 'as', 'assert', 'async', 'await', 'break', 'class',
...
# ''' We cannot use keywords as variables or identifiers'''{SyntaxError: cannot assign to any variables or identifiers}
# None=5
# True=3
# while=7